...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.tableViewMeta.setGeometry(QtCore.QRect(860, 170, 291, 341))
        self.tableViewMeta.setShowGrid(False)
        self.tableViewMeta.setObjectName(_fromUtf8("tableViewMeta"))
        self.tableViewMeta.horizontalHeader().setMinimumSectionSize(144)
        self.tableViewMeta.verticalHeader().setDefaultSectionSize(0)
        self.tableViewMeta.verticalHeader().setSortIndicatorShown(False)
