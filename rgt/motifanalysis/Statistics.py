...
def fisher_table_new((motif_name, regions, mpbs, return_geneset, output_mpbs_file)):
    """
    TODO
...
def get_fisher_dict_new(motif_names, region_file_name, mpbs_file_name, temp_file_path, return_geneset=False,
